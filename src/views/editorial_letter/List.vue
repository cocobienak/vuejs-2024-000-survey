<template>
  <div>
    <CCard>
      <CCardBody >
        <CButton
          ...
          square
          size="sm"
          @click="$router.push({path: '/editorial-letter/add'})"
        >
          Add new
        </CButton>
        <hr/>
            ...
            <div class="guard-status-info" style="display:flex;justify-content: flex-start; flex-wrap: wrap;">
              <div class="status-info">
                <a 
                  ...
                  :style="colorAll"
                  @click="is_publish='all';list_type='all';publish_status='all';processGetEditorialLetterList('search')"
                >
              ...
              <div class="status-info">
                <a
                  ...
                  @click="is_publish='published';list_type='all';publish_status='all';processGetEditorialLetterList('search')"
                >
              ...
              <div class="status-info">
                <a
                  ...
                  @click="is_publish='unpublished';list_type='all';publish_status='all';processGetEditorialLetterList('search')"
                >
              ...
              <div class="status-info">
                <a 
                  ...
                  @click="is_publish='unpublished_canpublish';list_type='all';publish_status='all';processGetEditorialLetterList('search')"
                >
              ...
              <div class="status-info" v-if="activeSystemUserDomain == 'master' || activeOauthClientId == 1">
                <a
                  ...
                  @click="is_publish='all';list_type='all';publish_status='publish_global';processGetEditorialLetterList('search')"
                >
              ...
              <div class="status-info" v-if="activeSystemUserDomain != 'master' && activeOauthClientId != 1">
                <a
                  ...
                  @click="is_publish='requestapproval';list_type='all';publish_status='all';processGetEditorialLetterList('search')"
                >
              ...
              <div class="status-info">
                <a
                  ...
                  @click="is_publish='all';list_type='all';publish_status='publish_global_rejected';processGetEditorialLetterList('search')"
                >
              ...
              <div class="status-info">
                <a
                  ...
                  :style="colorDraft"
                  @click="is_publish='all';list_type='all';publish_status='publish_global_draft';processGetEditorialLetterList('search')"
                >
          ...
          <CRow>            
            ...
            <CCol md="2">
              <CInput
                name="name"
                v-model="search_name"
                placeholder="Tittle Editorial Letter ..."               
              />
            </CCol> 
            ...
            <CCol md="2">
              <CButton
                ...
                square
                size="sm"
                @click="processGetEditorialLetterList('search')"
              >
                filter
              </CButton>
            </CCol>                                               
        ...
        <CRow>
            ...
            <CCol sm="2">
              ...
              <CSelect style="display: inline-block !important;width: 70% !important;"
                ...
                @input="pageDataBase=1;globalFunctions.changeDataPerPage($event,vm,'processGetEditorialLetterList','dataPerPage')"                
                  ...
                  <div v-if="activeSystemUserDomain == 'master' || activeOauthClientId == 1" style="padding-bottom:5px"> 
                    ...
                    <div v-else-if="item.publish_status=='publish_global_accepted' && item['domain_id.code']!='master'">
                      <CButton 
                        ...
                        square
                        size="sm"
                        @click="toggleRejectedPublishModal(item, 'Confirmation Un-Publish !!', 'Un-Publish editorial letter :')"
                      >
                        <span v-if="activeOauthClientId == 1">Un-Publish From WEB Editorial Letter</span>
                    ...
                    <div v-else-if="item.publish_status=='publish_global_accepted' && item['domain_id.code']=='master' && item.is_publish==1">
                      <CButton 
                        ...
                        square
                        size="sm"
                        @click="prosessPublishEditorialLetter(item)"
                      >
                        <span v-if="activeOauthClientId == 1">Un-Publish From WEB Editorial Letter</span>
                        <span v-else>Un-Publish</span>                      
                    ...
                    <div v-else-if="item.publish_status=='publish_global_accepted' && item['domain_id.code']=='master' && item.is_publish==0">
                      <CButton 
                        ...
                        @click="prosessPublishEditorialLetter(item)"
                      >
                        <span v-if="activeOauthClientId == 1">Publish From WEB Editorial Letter</span>
                  ...
                  <div v-if="(activeSystemUserDomain != 'master' && parseInt(item.domain_id) == parseInt(activeSystemUserDomainId)) || activeOauthClientId == 1" style="padding-bottom:5px"> 
                    ...
                    <div v-if="item.publish_status=='publish_global' && item['domain_id.code']!='master'">
                      ...
                      <CButton 
                        ...
                        square
                        size="sm"
                        @click="prosessPublishEditorialLetterDomainCancel(item)"
                      >
                        Cancel Publish 
                      </CButton>                         
                    </div> 
                    ...
                    <div v-else-if="(item.publish_status=='publish_global_accepted' || (item.publish_status=='publish_local' && item.is_publish_domain==0)) && item['domain_id.code']!='master'">
                      <CButton 
                        ...
                        square
                        size="sm"
                        @click="prosessPublishEditorialLetterDomain(item, true)"
                      >
                    ...
                    <div v-else-if="(item.publish_status=='publish_global_rejected' || item.publish_status=='publish_global_draft') && item['domain_id.code']!='master'">
                      ...
                      <CButton  style="margin-right:5px;"
                        ...
                        square
                        size="sm"
                        @click="prosessPublishEditorialLetterDomainApproval(item)"
                      >
                        Request Approval 
                      </CButton>
                  ...
                  <div v-if="(activeSystemUserDomain != 'master' && parseInt(item.domain_id) != parseInt(activeSystemUserDomainId) && activeOauthClientId != 1)" style="padding-bottom:5px"> 
                    ...
                    <div v-else-if="item['share_domain.is_publish']==0 && item.is_publish_domain_origin==1">
                      <CButton
                        ...
                        square
                        size="sm"
                        @click="prosessPublishEditorialLetterShare(item)"
                      >
                        Publish from share
                      </CButton>                  
                    </div>
                ...
                <div class="mfield-tools-detail border-right">
                  <div>
                    <CButton 
                      ...
                      square
                      size="sm"
                      @click="$router.push({ path: `/editorial-letter/edit/${item.id}` })"
                    >
                      Edit
                    </CButton>                
                  </div>                  
              ...
              <div v-if="activeSystemUserDomain == 'master' || activeOauthClientId == 1" style="padding-bottom:5px"> 
                ...
                <div v-else-if="item.publish_status=='publish_global_accepted' && item['domain_id.code']!='master'">
                  <label class="text-info label-adt" :style="colorPublished">
                      <span v-if="activeOauthClientId == 1">Published On WEB Editorial Letter</span>
                ...
                <div v-else-if="item.publish_status=='publish_global_accepted' && item['domain_id.code']=='master' && item.is_publish==0">
                  <label class="text-info label-adt" :style="colorUnpublished">
                        <span v-if="activeOauthClientId == 1">Un-Published On WEB Editorial Letter</span>
          ...
          <template #details="{item}">
            <CCollapse :show="Boolean(item._toggled)" :duration="collapseDuration">
              <CCardBody style="background:#dadada !important;"> 
                ...
                <CRow>
                  <CCol md="6">
                    <div>Banner Editorial Letter : </div>
                    <div v-if="(typeof(item['editorial_letter_image_id.path']) !== 'undefined' && item['editorial_letter_image_id.path'] !== '-' && item['editorial_letter_image_id.path'] !== null)">
                      <span 
                        ...
                        <img
                          ...
                          :src="item['editorial_letter_image_id.path']" 
                        />  
                      </span>                      
                    </div>                    
                  </CCol>                                    
      ...
      <div slot="footer-wrapper" class="w-100">
        <div class="modal-footer">
          <CButton
            ...
            square
            size="sm"
            @click="processDeleteEditorialLetter()"
          >
            Delete
          </CButton>
          <CButton
    ...
    >
      ...
      <br>
      <label>{{dataEditorialLetterModal.id}} : {{dataEditorialLetterModal.name}}</label>
      <br>
        <CTextarea
      ...
      <div slot="footer-wrapper" class="w-100">
        <div class="modal-footer">
          <CButton v-if="activeSystemUserDomain == 'master'"
            ...
            square
            size="sm"
            @click="prosessApprovalUnpublish(dataEditorialLetterModal, 0)"
          >
            Submit
          </CButton>
          <CButton v-if="(activeSystemUserDomain != 'master' && parseInt(dataEditorialLetterModal.domain_id) == parseInt(activeSystemUserDomainId))"
            class="button-adt" 
            :style="colorUnpublished"
            square
            size="sm"
            @click="prosessPublishEditorialLetterDomain(dataEditorialLetterModal)"
          >
            Un-Publish 
          </CButton>   
          <CButton
...
export default {
  ...
  data () {
    return {
      ...
      labelPublishModal : 'Reject publish editorial letter :',
      showRejectedPublishModal:false,
      dataEditorialLetterModal: {id: "", name:"", domain_id:null},
      search_name:"",
      editorial_letter_start:"",
      list_type:'all',
      list_domain : {
        value : [],
        tempValue : "",
  ...
  mounted() {
    this.processGetEditorialLetterList(null);
  ...
  methods: {
    ...
    processGetEditorialLetterList: function (action = null) {
...
//   { value: 'publish_global_rejected', label: 'Status Rejected Unpublish' }]
      ...
      baseCallApiHelper.callApi(
          "Get editorial letter  list",
          null,
          api.editorial_letter.list.method,
          api.editorial_letter.list.url, 
          data, 
          (status, data, message) => {
            if(status) {
              ...
              this.$refs.Pagination_Top.functionNameRefreshList = "processGetEditorialLetterList";
              ...
              this.$refs.Pagination_Bottom.functionNameRefreshList = "processGetEditorialLetterList";
              this.$refs.Pagination_Bottom.togglePagination(this.pageDataBase, data.last_page); 
              this.processGetCountEditorialLetterList();
    ...
    processGetCountEditorialLetterList: function (e) {
        const data = {};

        baseCallApiHelper.callApi(
          "Get editorial letter  list",
          null,
          api.editorial_letter.getcount.method,
          api.editorial_letter.getcount.url, 
          data, 
          (status, data, message) => {
            if(status) {
    ...
    prosessApprovalUnpublish: function(item, acceptAction, allowCheckFieldForm = false) {
      ...
      if (globalFunctions.validationForm(this, 'fieldFormPublish') || allowCheckFieldForm) {
        const data = {
          editorial_letter_id : item.id,
          is_publish : acceptAction,
          publish_message : this.fieldFormPublish.publish_message.value
        };

        baseCallApiHelper.callApi(
          "Proses approval unpublish editorial letter",
          null,
          api.editorial_letter.approvalunpublish.method,
          api.editorial_letter.approvalunpublish.url, 
          data, 
          (status, data, message) => {
            this.processGetEditorialLetterList();
          }, 
          true, 
          true,
          true
    ...
    prosessPublishEditorialLetter: function(item) {
      this.showRejectedPublishModal = false;
        ...
        baseCallApiHelper.callApi(
          "Proses publish editorial letter",
          null,
          api.editorial_letter.publish.method,
          api.editorial_letter.publish.url, 
          data, 
          (status, data, message) => {
            this.processGetEditorialLetterList();
          }, 
    ...
    prosessPublishEditorialLetterDomain: function(item, allowCheckFieldForm = false)  {
      this.showRejectedPublishModal = false;
      if (globalFunctions.validationForm(this, 'fieldFormPublish') || allowCheckFieldForm) {
        ...
        baseCallApiHelper.callApi(
          "Proses publish editorial letter origin",
          null,
          api.editorial_letter.publishdomain.method,
          api.editorial_letter.publishdomain.url, 
          data, 
          (status, data, message) => {
            this.processGetEditorialLetterList();
          }, 
    ...
    prosessPublishEditorialLetterDomainApproval: function(item)  {
    ...
    prosessPublishEditorialLetterDomainCancel: function(item)  {
        const data = {
          editorial_letter_id : item.id,
          is_publish : 0,
    ...
    prosessPublishEditorialLetterShare: function(item) {
        const data = {
          editorial_letter_id : item.id,
        ...
        baseCallApiHelper.callApi(
          "Proses publish editorial letter share",
          null,
          api.editorial_letter.publishshare.method,
          api.editorial_letter.publishshare.url, 
          data, 
          (status, data, message) => {
            this.processGetEditorialLetterList();
          }, 
    ...
    toggleRejectedPublishModal : function(item, titleModal = 'Confirmation Rejected !!', labelModal = 'Reject publish editorial letter :') {
      ...
      if (this.showRejectedPublishModal) {
        this.dataEditorialLetterModal = item;
      } else {
        this.fieldFormPublish.publish_message.value = "";
        this.dataEditorialLetterModal = {id: "", name:"", domain_id:null};
      }
    },    
    
    processDeleteEditorialLetter: function () {
      const data = {
      };      
      if (this.itemDeleteID) {
        baseCallApiHelper.callApi(
          "Delete editorial letter ",
          null,
          api.editorial_letter.delete.method,
          api.editorial_letter.delete.url + '/' + this.itemDeleteID, 
          data, 
          (status, data, message) => {
            this.itemDeleteID = null;              

            if(status){
              this.processGetEditorialLetterList('delete');
            }
          }, 
          true, 
          true,
