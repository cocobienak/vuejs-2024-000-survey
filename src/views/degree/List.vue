    ...
    <CCard>
      <CCardBody>
        <CButton
          ...
          square
          size="sm"
          @click="$router.push({path: '/degree/add'})"
        >
          Add new
        </CButton>
        <hr/>
          ...
          <template #edit_button="{item}">
            <td class="py-2">
              <CButton
                ...
                square
                size="sm"
                @click="$router.push({ path: `/degree/edit/${item.id}` })"
              >
                Edit
              </CButton>
            </td>
        ...
        <CButton
          ...
          square
          size="sm"
          @click="globalFunctions.togglePrevious100k(vm, vm.processGetDegreeList)"
        >
        ...
        <CButton
          ...
          square
          size="sm"
          @click="globalFunctions.toggleNext100k(vm, vm.processGetDegreeList)"
        >
          Next 100k record
        </CButton>
      </CCardBody>
...
export default {
  ...
  data () {
    return {
      ...
      fields : [
        ...
        { key: 'title', label: 'title', _style:'min-width:100px', isFields: true },
  ...
  methods: {
    processGetDegreeList: function (e) {
        const data = {
    ...
    processDeleteDegree: function () {
      ...
      if (this.itemDeleteID) {
        baseCallApiHelper.callApi(
          "Delete degree",
          null,
          api.degree.delete.method,
          api.degree.delete.url + '/' + this.itemDeleteID, 
          data, 
          (status, data, message) => {
