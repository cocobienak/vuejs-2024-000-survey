    ...
    <CCard>
      <CCardBody>
        <CButton
          ...
          square
          size="sm"
          @click="$router.push({path: '/module/add'})"
        >
          Add new
        </CButton>
        <hr/>
          ...
          <template #edit_button="{item}">
            <td class="py-2">
              <CButton
                ...
                square
                size="sm"
                @click="$router.push({ path: `/module/edit/${item.id}` })"
              >
                Edit
              </CButton>
            </td>
        ...
        <CButton
          ...
          square
          size="sm"
          @click="globalFunctions.togglePrevious100k(vm, vm.processGetModuleList)"
        >
        ...
        <CButton
          ...
          square
          size="sm"
          @click="globalFunctions.toggleNext100k(vm, vm.processGetModuleList)"
        >
          Next 100k record
        </CButton>
      </CCardBody>
...
export default {
  ...
  data () {
    return {
      ...
      fields : [
        ...
        { key: 'code', label: 'Code', _style:'min-width:100px', isFields: true },
  ...
  mounted() {
    this.processGetModuleList();
  },
  methods: {
    processGetModuleList: function (e) {
        const data = {
    ...
    processDeleteModule: function () {
      ...
      if (this.itemDeleteID) {
        baseCallApiHelper.callApi(
          "Delete module",
          null,
          api.module.delete.method,
          api.module.delete.url + '/' + this.itemDeleteID, 
          data, 
          (status, data, message) => {
